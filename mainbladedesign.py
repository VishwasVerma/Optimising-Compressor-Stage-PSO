...
n_values = np.linspace(0,1,21) 					#3-D streching parameter
...
popsize=100	# to have finite number of populations
...
breaking_point = 100	# Store 100 potential candiates 
	...
	while not done:
		...
		if epoch < MAX_EPOCHS:
			...
			for j in range(POPULATION):
				if (0.9-0.004) <= Blades[j].total_efficiency <= (0.9+0.004):
